...
def create_user(**param):
    """
    Creates and returns a user object for given parameters
    :param param: a list of parameters for creating the user
    """
...
class PublicUserApiTests(TestCase):
    """
    Test users apis which are publicly available
    """
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(**payload)
        # Change the password to invalidate credentials
...
class PrivateUserApiTest(TestCase):
    """
    Test users apis which are available to authenticated users
    """
